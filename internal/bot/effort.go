...
var effortConfigs = map[EffortLevel]EffortConfig{
	...
	EffortHigh:   {Model: "claude-opus-5", ThinkingTokens: 16000},
	EffortXHigh:  {Model: "claude-opus-5", ThinkingTokens: 32000},
	EffortMax:    {Model: "claude-opus-5", ThinkingTokens: 64000},
	EffortUltra:  {Model: "claude-fable-5-1", ThinkingTokens: 64000},
}
...
func formatEffortHelpReply() string {
	lines := []string{
		...
		"  high   — claude-opus-5    · thinking 16000",
		"  xhigh  — claude-opus-5    · thinking 32000",
		"  max    — claude-opus-5    · thinking 64000",
		"  ultra  — claude-fable-5-1 · thinking 64000",
		"",
